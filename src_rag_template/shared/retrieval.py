...
def make_lancedb_retriever(
    ...
    """Configure this agent to connect to a local LanceDB database."""
    import lancedb
    from langchain_community.vectorstores import LanceDB

    # Create or connect to LanceDB database
    # LanceDB will create the database directory if it doesn't exist
    db_path = os.environ.get("LANCEDB_PATH", "./lancedb")
    table_name = os.environ.get("LANCEDB_TABLE", "langchain_documents")
    
    # Use from_documents method to create LanceDB instance 
    # This ensures proper table creation
    vstore = LanceDB(
        uri=db_path,
        embedding=embedding_model,
