    ...
    query_model: Annotated[str, {"__template_metadata__": {"kind": "llm"}}] = field(
        ...
        metadata={
            "description": "The language model used for processing and refining queries. Should be in the form: provider/model-name. "
                          "Supported providers: anthropic, openai, ollama, google-genai. "
                          "Examples: 'anthropic/claude-3-haiku-20240307', 'openai/gpt-4o-mini', 'ollama/llama3.2:3b', 'google-genai/gemini-1.5-flash'"
        },
    )
    ...
    response_model: Annotated[str, {"__template_metadata__": {"kind": "llm"}}] = field(
        ...
        metadata={
            "description": "The language model used for generating responses. Should be in the form: provider/model-name. "
                          "Supported providers: anthropic, openai, ollama, google-genai. "
                          "Examples: 'anthropic/claude-3-5-sonnet-20240620', 'openai/gpt-4o', 'ollama/llama3.2:8b', 'google-genai/gemini-1.5-pro'"
        },
    )
